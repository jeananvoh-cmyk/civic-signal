...
class ReportModel {
  ...
  ReportModel copyWith({
    ...
    String? userId,
    String? ticketCode,
    String? padaCommuneCode,
    String? padaStreetName,
    String? padaFormattedAddress,
    ...
    String? operatorLastNote,
  }) {
    return ReportModel(
      id: id ?? this.id,
      userId: userId ?? this.userId,
      ticketCode: ticketCode ?? this.ticketCode,
      padaCommuneCode: padaCommuneCode ?? this.padaCommuneCode,
      padaStreetName: padaStreetName ?? this.padaStreetName,
      padaFormattedAddress: padaFormattedAddress ?? this.padaFormattedAddress,
      ...
      repairVerifications: repairVerifications ?? this.repairVerifications,
      impactedPeople: impactedPeople ?? this.impactedPeople,
      ...
      operatorLastNote: operatorLastNote ?? this.operatorLastNote,
    );
  }
