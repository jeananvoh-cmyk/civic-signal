...
const Map<String, PadaCommuneInfo> PADA_COMMUNES = {
  ...
  'Brofodoumé': PadaCommuneInfo(codeDept: '002', codeSp: '04', codeComplet: '002-04', commune: 'Brofodoumé', trigramme: 'BRO'),
...
String getCommuneTrigramme(String commune) {
...
String getCommunePadaCode(String commune) {
  final info = PADA_COMMUNES[commune];
  return info != null ? info.codeComplet : '002-XX';
}

String formatPadaAddress({
  String? streetName,
  String? streetNumber,
